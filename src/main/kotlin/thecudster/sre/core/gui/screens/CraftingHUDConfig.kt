...
class CraftingHUDConfig : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (!input!!.isFocused) {
            input!!.text = ""
            ScreenRenderer.fontRenderer.drawString("Search for an item...", input!!.xPosition + 5f, input!!.yPosition  + 6f, CommonColors.GRAY, SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NORMAL)
            ...
            if (input!!.text.isNotEmpty() && input!!.text.isNotBlank()) {
                ...
                if (buttonList.filterIsInstance<SearchOptionButton>().isNotEmpty()) {
                    ...
                    GlStateManager.popMatrix()
                    ScreenRenderer.fontRenderer.drawString("No options found ):", input!!.xPosition.toFloat() + 4, input!!.yPosition.toFloat() + 30, CommonColors.WHITE, SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NORMAL)
                }
                ...
                GlStateManager.popMatrix()
                ScreenRenderer.fontRenderer.drawString("Search for a forgeable item!", input!!.xPosition.toFloat() + 4, input!!.yPosition.toFloat() + 30, CommonColors.WHITE, SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NORMAL)
            }
        }
        ...
        if (button is DropdownButton) {
         ...
         if (button === close) {
             ...
             if (button is DropdownButton && button.item.subcategory != null) {
                     if (button.toggled) {
                     var x = if (button.xPosition + 200 > input!!.xPosition) width / 10 else button.xPosition + 160
                     var lowest = 0
    ...
    override fun keyTyped(typedChar: Char, keyCode: Int) {
        ...
        if (input!!.isFocused) {
            ...
            var closestMatches = arrayListOf<Item>()
            Item.values().forEach {
                if (it.itemName.toLowerCase().contains(input!!.text.toLowerCase()) && closestMatches.size < 6 && it.subcategory != null) {
...
enum class Item(
    ...
    REFINED_MITHRIL("Refined Mithril", "sre:forge/refmithril.png", hashMapOf(ENCHANTED_MITHRIL to 160), ItemRarity.EPIC),
    ENCHANTED_TITANIUM("Enchanted Titanium", "sre:forge/etita.png", null, ItemRarity.EPIC),
    REFINED_TITANIUM("Refined Titanium", "sre:forge/reftita.png", hashMapOf(ENCHANTED_TITANIUM to 16), ItemRarity.LEGENDARY),
    GOLD("Gold", "", null, ItemRarity.COMMON, getItem(MinecraftItem.gold_ingot, true)),
    ENCHANTED_GOLD("Enchanted Gold", "", hashMapOf(GOLD to 160), ItemRarity.UNCOMMON, getItem(MinecraftItem.gold_ingot, true)),
    ENCHANTED_GOLD_BLOCK("Enchanted Gold Block", "", hashMapOf(ENCHANTED_GOLD to 160), ItemRarity.RARE, getItem(Blocks.gold_block, true)),
    ...
    ENCHANTED_DIAMOND("Enchanted Diamond", "", hashMapOf(DIAMOND to 160), ItemRarity.UNCOMMON, getItem(MinecraftItem.diamond, true)),
    ENCHANTED_DIAMOND_BLOCK("Enchanted Diamond Block", "", hashMapOf(ENCHANTED_DIAMOND to 160), ItemRarity.RARE, getItem(Blocks.diamond_block, true)),
    REFINED_DIAMOND("Refined Diamond", "", hashMapOf(ENCHANTED_DIAMOND_BLOCK to 2), ItemRarity.EPIC, getItem(MinecraftItem.diamond, true)),
    COAL("Coal", "", null, ItemRarity.COMMON, getItem(MinecraftItem.coal, false)),
    ENCHANTED_COAL("Enchanted Coal", "", hashMapOf(COAL to 160), ItemRarity.UNCOMMON, getItem(MinecraftItem.coal, true)),
    ENCHANTED_COAL_BLOCK("Enchanted Coal Block", "", hashMapOf(ENCHANTED_COAL to 160), ItemRarity.RARE, getItem(Blocks.coal_block, true)),
    IRON("Iron", "", null, ItemRarity.COMMON, getItem(MinecraftItem.iron_ingot, false)),
    ENCHANTED_IRON("Enchanted Iron", "", hashMapOf(IRON to 160), ItemRarity.UNCOMMON, getItem(MinecraftItem.iron_ingot, true)),
    ENCHANTED_IRON_BLOCK("Enchanted Iron Block", "", hashMapOf(ENCHANTED_IRON to 160), ItemRarity.RARE, getItem(Blocks.iron_block, true)),
    REDSTONE("Redstone", "", null, ItemRarity.COMMON, getItem(MinecraftItem.redstone, false)),
    ENCHANTED_REDSTONE("Enchanted Redstone", "", hashMapOf(REDSTONE to 160), ItemRarity.UNCOMMON, getItem(MinecraftItem.redstone, true)),
    ENCHANTED_REDSTONE_BLOCK("Enchanted Redstone Block", "", hashMapOf(ENCHANTED_REDSTONE to 160), ItemRarity.RARE, getItem(Blocks.redstone_block, true)),
    ...
    GOLDEN_PLATE("Golden Plate", "sre:forge/gplate.png", hashMapOf(ENCHANTED_GOLD_BLOCK to 2, GLACITE_JEWEL to 5, REFINED_DIAMOND to 1), ItemRarity.RARE),
    FUEL_TANK("Fuel Tank", "sre:forge/ftank.png", hashMapOf(ENCHANTED_COAL_BLOCK to 2), ItemRarity.RARE),
    DRILL_ENGINE("Drill Engine", "sre:forge/dengine.png", hashMapOf(ENCHANTED_IRON_BLOCK to 1,
        ENCHANTED_REDSTONE_BLOCK to 3, TREASURITE to 10, REFINED_DIAMOND to 1, GOLDEN_PLATE to 1), ItemRarity.RARE),
    MITHRIL_PLATE("Mithril Plate", "sre:forge/mplate.png", hashMapOf(REFINED_MITHRIL to 5, ENCHANTED_IRON_BLOCK to 1, REFINED_TITANIUM to 1, GOLDEN_PLATE to 1), ItemRarity.RARE),
    PLASMA("Plasma", "sre:forge/plasma.png", null, ItemRarity.RARE),
    BEJEWELED_HANDLE("Bejeweled Handle", "", hashMapOf(GLACITE_JEWEL to 3), ItemRarity.RARE, getItem(MinecraftItem.stick, true)),

    TITA_DRILL_1("Titanium Drill DR-X355", "", hashMapOf(REFINED_MITHRIL to 10, REFINED_TITANIUM to 10, GOLDEN_PLATE to 6, FUEL_TANK to 1, DRILL_ENGINE to 1),
        ItemRarity.EPIC, CraftingHUDConfig.drillItem),
    TITA_DRILL_2("Titanium Drill DR-X455", "", hashMapOf(TITA_DRILL_1 to 1, REFINED_DIAMOND to 10, REFINED_TITANIUM to 16, MITHRIL_PLATE to 6),
        ItemRarity.EPIC, CraftingHUDConfig.drillItem),
    TITA_DRILL_3("Titanium Drill DR-X555", "", hashMapOf(TITA_DRILL_2 to 1, PLASMA to 20, MITHRIL_PLATE to 15, ENCHANTED_IRON_BLOCK to 2, REFINED_TITANIUM to 32, REFINED_DIAMOND to 20),
        ItemRarity.EPIC, CraftingHUDConfig.drillItem),

    MITHRIL_PICK_1("Mithril Pickaxe", "", hashMapOf(ENCHANTED_MITHRIL to 30, BEJEWELED_HANDLE to 1, ENCHANTED_GOLD to 10), ItemRarity.UNCOMMON, getItem(MinecraftItem.iron_pickaxe, true)),
    BEACON_II("Beacon II", "", hashMapOf(REFINED_MITHRIL to 5), ItemRarity.RARE, getItem(Blocks.beacon, false)),
    TITANIUM_TALISMAN("Titanium Talisman", "sre:forge/titatali.png", hashMapOf(REFINED_TITANIUM to 2), ItemRarity.UNCOMMON),
    DIAMONITE("Diamonite", "sre:forge/diamonite.png", hashMapOf(REFINED_DIAMOND to 3), ItemRarity.RARE),
    POWER_CRYSTAL("Power Crystal", "", hashMapOf(STARFALL to 256), ItemRarity.EPIC, getItem(MinecraftItem.nether_star, true)),
    MITHRIL_PICK_2("Refined Mithril Pickaxe", "", hashMapOf(REFINED_MITHRIL to 3, BEJEWELED_HANDLE to 2, REFINED_DIAMOND to 1, ENCHANTED_GOLD to 30), ItemRarity.RARE,
        getItem(MinecraftItem.iron_pickaxe, true)),
    MITHRIL_DRILL_1("Mithril Drill SX-R226", "", hashMapOf(DRILL_ENGINE to 1, REFINED_MITHRIL to 3, FUEL_TANK to 1), ItemRarity.RARE, CraftingHUDConfig.drillItem),
    MITHRIL_DRILL_2("Mithril Drill SX-R326", "", hashMapOf(MITHRIL_DRILL_1 to 1, GOLDEN_PLATE to 10, MITHRIL_PLATE to 2), ItemRarity.EPIC, CraftingHUDConfig.drillItem),
    MITHRIL_FUEL_TANK("Mithril-Infused Fuel Tank", "", hashMapOf(MITHRIL_PLATE to 3, FUEL_TANK to 5), ItemRarity.RARE),
    MITHRIL_DRILL_ENGINE("Mithril-Plated Drill Engine", "", hashMapOf(DRILL_ENGINE to 2, MITHRIL_PLATE to 3), ItemRarity.RARE),
    ...
    TITANIUM_INFUSED_FUEL_TANK("Titanium-Infused Fuel Tank", "", hashMapOf(REFINED_TITANIUM to 10, REFINED_DIAMOND to 10, REFINED_MITHRIL to 10, FUEL_TANK to 10), ItemRarity.RARE),
    BEACON_V("Beacon V", "", hashMapOf(BEACON_IV to 1, REFINED_MITHRIL to 40, PLASMA to 5), ItemRarity.EPIC),
    TITANIUM_RELIC("Titanium Relic", "", hashMapOf(REFINED_TITANIUM to 20, TITANIUM_ARTIFACT to 1), ItemRarity.LEGENDARY),

    // crystal hollows update

    // mats
    FINE_JADE_GEMSTONE("Fine Jade Gemstone", "", null, ItemRarity.UNCOMMON),
    FINE_AMBER_GEMSTONE("Fine Amber Gemstone", "", hashMapOf(), ItemRarity.UNCOMMON),
    FINE_AMETHYST_GEMSTONE("Fine Amethyst Gemstone", "", hashMapOf(), ItemRarity.UNCOMMON),
    FINE_SAPPHIRE_GEMSTONE("Fine Sapphire Gemstone", "", hashMapOf(), ItemRarity.UNCOMMON),
    FINE_RUBY_GEMSTONE("Fine Ruby Gemstone", "", hashMapOf(), ItemRarity.UNCOMMON),
    FINE_TOPAZ_GEMSTONE("Fine Topaz Gemstone", "", hashMapOf(), ItemRarity.UNCOMMON),
    FINE_JASPER_GEMSTONE("Fine Jasper Gemstone", "", hashMapOf(), ItemRarity.UNCOMMON),
    SLUDGE_JUICE("Slude Juice", "", hashMapOf(), ItemRarity.UNCOMMON),
    RED_GOBLIN_EGG("Red Goblin Egg", "", null, ItemRarity.UNCOMMON, getItem(MinecraftItem.egg, false)),
    HARD_STONE("Hard Stone", "", hashMapOf(), ItemRarity.COMMON),
    ...
    GEMSTONE_MIXTURE("Gemstone Mixture", "", hashMapOf(FINE_JADE_GEMSTONE to 2, FINE_AMBER_GEMSTONE to 2, FINE_AMETHYST_GEMSTONE to 2, FINE_SAPPHIRE_GEMSTONE to 2,
    ...
    SUNNY_SIDE_GOBLIN_OMLETTE("Sunny Side Goblin Omelette", "", hashMapOf(YELLOW_GOBLIN_EGG to 99, FINE_TOPAZ_GEMSTONE to 1), ItemRarity.UNCOMMON),
    RUBY_DRILL_1("Ruby Drill Model TX-15", "", hashMapOf(DRILL_ENGINE to 1, FUEL_TANK to 1, FINE_RUBY_GEMSTONE to 6), ItemRarity.RARE, CraftingHUDConfig.drillItem),
    RUBY_DRILL_2("Topaz Drill KGR-12", "", hashMapOf(RUBY_DRILL_1 to 1, GEMSTONE_MIXTURE to 3, MAGMA_CORE to 5), ItemRarity.EPIC, CraftingHUDConfig.drillItem),
    RUBY_DRILL_ENGINE("Ruby-polished Drill Engine", "", hashMapOf(MITHRIL_DRILL_ENGINE to 1, SUPERLITE_MOTOR to 10, FINE_RUBY_GEMSTONE to 10), ItemRarity.RARE),
    GEMSTONE_FUEL_TANK("Gemstone Fuel Tank", "", hashMapOf(TITANIUM_INFUSED_FUEL_TANK to 1, CONTROL_SWITCH to 30, GEMSTONE_MIXTURE to 10), ItemRarity.RARE),
    CORLEONITE("Corleonite", "", null, ItemRarity.EPIC),
    TITA_DRILL_4("Titanium Drill DR-X655", "", hashMapOf(CORLEONITE to 30, TITA_DRILL_3 to 1, REFINED_DIAMOND to 5, GEMSTONE_MIXTURE to 16, REFINED_TITANIUM to 12, MITHRIL_PLATE to 5), ItemRarity.LEGENDARY, CraftingHUDConfig.drillItem),
}
class nonDropdownButton(
    ...
    ScreenRenderer.fontRenderer.getStringWidth("${item.itemName} x${if (parent != null && parent!!.subcategory!!.containsKey(item)) parent!!.subcategory!!.get(item) else 1} ⇦"),
    ...
    override fun drawButton(mc: Minecraft?, mouseX: Int, mouseY: Int) {
        if (visible) {
            ...
            ScreenRenderer.fontRenderer.drawString(
                displayString, xPosition.toFloat(), yPosition + (height - 8) / 2f, CustomColor.SetBase(item.rarity.color.rgb), SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NORMAL
            )
        }
...
class DropdownButton(
    ...
    override fun drawButton(mc: Minecraft?, mouseX: Int, mouseY: Int) {
        if (visible) {
            ...
            hovered =
                mouseX >= xPosition && mouseY >= yPosition && mouseX < xPosition + width && mouseY < yPosition + height
            var colour = if (hovered) CommonColors.RAINBOW else CustomColor.SetBase(item.rarity.color.rgb)
            ...
            ScreenRenderer.fontRenderer.drawString(
                displayString, xPosition.toFloat(), yPosition + (height - 8) / 2f, colour, SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NORMAL
            )
...
class SearchOptionButton(
    val item: Item, private val x: Int, private val y: Int) : GuiButton(69, x, y,
    ...
    override fun drawButton(mc: Minecraft?, mouseX: Int, mouseY: Int) {
        if (visible) {
            ...
            hovered =
                mouseX >= xPosition && mouseY >= yPosition && mouseX < xPosition + width && mouseY < yPosition + height
            var colour = if (hovered && !enabled) CommonColors.RAINBOW else CustomColor.SetBase(item.rarity.color.rgb)
            ScreenRenderer.fontRenderer.drawString(
                displayString, xPosition.toFloat(), yPosition + (height - 8) / 2f, colour, SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NORMAL
            )
        }
