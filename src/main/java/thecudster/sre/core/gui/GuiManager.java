...
public class GuiManager {
    ...
    public static void createTitle(String title, int ticks) {
        createTitle(EnumChatFormatting.RED, title, ticks);
    }
    public static void createTitle(EnumChatFormatting colour, String title, int ticks) {
        Utils.playLoudSound("random.orb", 0.5);
        GuiManager.title = colour + title;
